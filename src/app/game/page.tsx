...
export default function GamePage() {
  const { 
    // score, currentLetter, checkAnswer, 
    startGame } = useGame();
  
  // إضافة حالة للاعبين
  const [players] = useState([
    { id: 1, name: "لاعب 1", active: true, team: 'red' as const },
    { id: 2, name: "لاعب 2", active: true, team: 'red' as const },
    { id: 3, name: "لاعب 3", active: true, team: 'green' as const },
    { id: 4, name: "لاعب 4", active: true, team: 'green' as const }
  ]);
  ...
  return (
    <div className="min-h-screen flex flex-col items-center justify-center p-4">
      ...
      <EnhancedHexagonBoard
        ...
        players={players}
        teamName="لعبة حروف"
        onSelectNewLetter={(letter) => console.log(`تم اختيار الحرف ${letter}`)}
      />
    </div>
  );
}